...
CONFIG_FILE="${BENCH_PATH}/sites/common_site_config.json" 
...
bench set-mariadb-host mariadb ; check_init_command "set mariadb host"
...
SITE_NAME="__DEFAULT_SITE_PLACEHOLDER__" 
...
if [ -f "$PROCFILE_PATH" ]; then
    ...
    NVM_LOAD_COMMAND_ESCAPED=$(echo "$NVM_LOAD_COMMAND" | sed 's/\//\\\//g; s/\&/\\\&/g')
